                    ...
                    <table class="table table-striped">
                      ...
                      @foreach($courseList as $course)
                        <tr>
                          ...
                          <form action="{{ route('course.destroy', $course->cID) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" method="POST">
                    ...
                    <div class="form-group">
                        <label for="course_id">Course ID</label>
                        <input type="text" class="form-control" id="course_id" name="course_id" value="{{ old('course_id', $course->course_id) }}">
                    </div>
                    <div class="form-group">
                        <label for="course_name">Course Name</label>
   ...
   <script>
    document.addEventListener('DOMContentLoaded',function() {
      ...
      $('#editModal').on('show.bs.modal', function (event) {
        ...
        var formAction = "{{ route('course.update', ':id') }}".replace(':id', cID); // Replace with dynamic URL as needed
