                    ...
                    <table class="table table-striped">
                      ...
                      @foreach($dateList as $date)
                        <tr>
                          ...
                          data-did="{{ $date->dID }}" 
                          data-dated="{{ $date->date }}"
                          data-stts="{{ $date->status }}">
                          <i class="mdi mdi-pencil"></i> </button>
                          </a>
                          <form action="{{ route('date.destroy', $date->dID) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="form-group">
                      <label for="date">Date</label>
                      <input type="date" class="form-control" id="date" name="date" value="{{ old('date', $date->date) }}">
                    </div>
                    <div class="form-group">
                      <label for="status">Status</label>
                      <select class="form-control" id="status" name="status" required>
                        <option value="active" {{ $date->status == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="disactive" {{ $date->status == 'disactive' ? 'selected' : '' }}>Disactive</option>
                      </select>
                    </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
  ...
  <script>
    document.addEventListener('DOMContentLoaded',function() {
      ...
      $('#editModal').on('show.bs.modal', function (event) {
        ...
        var formAction = "{{ route('date.update', ':id') }}".replace(':id', dID); // Replace with dynamic URL as needed
