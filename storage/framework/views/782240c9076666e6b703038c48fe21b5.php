<nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row" 
     style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo e(asset('images/bg.png')); ?>'); 
      ...
      </nav><?php /**PATH C:\inetpub\wwwroot\project\resources\views/navbar.blade.php ENDPATH**/ ?>